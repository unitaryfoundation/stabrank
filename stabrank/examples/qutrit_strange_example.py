...
def run_qutrit_strange_example():
    """
    Runs an example of finding a stabilizer rank decomposition for the Qutrit Strange State (|S>).
    """
    print("\n--- Qutrit Strange State Decomposition Example (|S>) ---")
    ...
    # Target: Strange state
    target_func = qutrit_strange_state(n_orig)
    ...
    while current_k > 0:
        ...
        if found_solution:
            ...
            filename = f"solution_qutrit_strange_k{current_k}_n{n_orig}_{timestamp}.npz"
