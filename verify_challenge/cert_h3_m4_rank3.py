"""Certificate: chi(|H3>^{ot 4}) >= 4, by excluding every rank-3 decomposition
...
Printed claims: CERTIFIED chi(H3^4) >= 3
                CERTIFIED chi(H3^4) >= 4
"""
...
if __name__ == "__main__":
    raise SystemExit(0 if certify_m4("H3") == 3 else 1)
