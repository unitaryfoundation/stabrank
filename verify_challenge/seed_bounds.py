...
LIT = [
    ...
    ("qubit_H", 5, "upper", 6, "Bravyi, Smith, and Smolin", "arXiv:1506.01396", "numerical, conjectured optimal there"),
    ("qubit_H", 6, "upper", 7, "Bravyi, Smith, and Smolin", "arXiv:1506.01396", "underpins the standard 2^{0.47n} figure; superseded by rank 6"),
    ("qubit_H", 6, "upper", 6, "Qassim, Pashayan, and Gosset", "arXiv:2106.07740", "cat-state construction, their Eq. 7"),
