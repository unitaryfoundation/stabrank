"""Certificate: chi(|N>^{ot 3}) >= 4, by excluding every rank-3 decomposition.
...
Printed claim: CERTIFIED chi(N^3) >= 4
"""
...
if __name__ == "__main__":
    raise SystemExit(run_certificate(cells=[("N", 3)], controls=[("N", 2)]))
